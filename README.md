...
- [This
  Release](https://github.com/vertigis/studio-base-internal/releases/v14805232480-master)
  ( v14805232480-master )
...
> cd deploy-studio
> curl -fsSL https://github.com/vertigis/studio-base-internal/archive/refs/tags/v14805232480-master.tar.gz | tar -xz

# Using cmd on Windows
> mkdir deploy-studio
> cd deploy-studio
> curl -fsSL https://github.com/vertigis/studio-base-internal/archive/refs/tags/v14805232480-master.tar.gz -o deploy.tar.gz
> tar -xzf deploy.tgz
> del deploy.tgz
...
> mkdir deploy-studio
> cd deploy-studio
> iwr -Uri https://github.com/vertigis/studio-base-internal/archive/refs/tags/v14805232480-master.zip -OutFile deploy.zip
> exa -Path deploy.zip -DestinationPath .
> del deploy.zip

# Using git
> git clone --depth 1 --branch v14805232480-master https://github.com/vertigis/studio-base-internal deploy-studio
> cd deploy-studio
```
