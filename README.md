...
- [Activate the Product](#activate-the-product)
...
- [This
  Release](https://github.com/vertigis/studio-base-internal/releases/v15497316640-master)
  ( v15497316640-master )
...
> cd ~/deploy-studio
> curl -fsSL https://github.com/vertigis/studio-base-internal/archive/refs/tags/v15497316640-master.tar.gz | tar -xz
# If desired, use git:
> git clone --depth 1 --branch v15497316640-master https://github.com/vertigis/studio-base-internal ~/deploy-studio
> cd ~/deploy-studio
