...
- [This
  Release](https://github.com/vertigis/studio-base-internal/releases/v14479324188-master)
  ( v14479324188-master )
...
> cd deploy-studio
> curl -fsSL https://github.com/vertigis/studio-base-internal/archive/refs/tags/v14479324188-master.tar.gz | tar -xz

# Using cmd on Windows
> mkdir deploy-studio
> cd deploy-studio
> curl -fsSL https://github.com/vertigis/studio-base-internal/archive/refs/tags/v14479324188-master.tar.gz -o deploy.tar.gz
> tar -xzf deploy.tgz
> del deploy.tgz
...
> mkdir deploy-studio
> cd deploy-studio
> iwr -Uri https://github.com/vertigis/studio-base-internal/archive/refs/tags/v14479324188-master.zip -OutFile deploy.zip
> exa -Path deploy.zip -DestinationPath .
> del deploy.zip

# Using git
> git clone --depth 1 --branch v14479324188-master https://github.com/vertigis/studio-base-internal deploy-studio
> cd deploy-studio
```
