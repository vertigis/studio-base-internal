...
- [This
  Release](https://github.com/vertigis/studio-base-internal/releases/v0-pr-13360749778)
  ( v0-pr-13360749778 )
...
> mkdir deploy-studio
> cd deploy-studio
> curl -fsSL https://github.com/vertigis/studio-base-internal/archive/refs/tags/v0-pr-13360749778.tar.gz -o deploy.tar.gz
> tar -xzf deploy.tgz
> del deploy.tgz
```
...
> mkdir deploy-studio
> cd deploy-studio
> iwr -Uri https://github.com/vertigis/studio-base-internal/archive/refs/tags/v0-pr-13360749778.zip -OutFile deploy.zip
> exa -Path deploy.zip -DestinationPath .
> del deploy.zip
```

``` git
> git clone --depth 1 --branch v0-pr-13360749778 https://github.com/vertigis/studio-base-internal deploy-studio
> cd deploy-studio
```
