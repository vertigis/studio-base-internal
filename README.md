...
- [This
  Release](https://github.com/vertigis/studio-base-internal/releases/v14982313549-master)
  ( v14982313549-master )
...
> cd deploy-studio
> curl -fsSL https://github.com/vertigis/studio-base-internal/archive/refs/tags/v14982313549-master.tar.gz | tar -xz

# Using cmd on Windows
> mkdir deploy-studio
> cd deploy-studio
> curl -fsSL https://github.com/vertigis/studio-base-internal/archive/refs/tags/v14982313549-master.tar.gz -o deploy.tgz
> tar -xzf deploy.tgz
> del deploy.tgz
...
> mkdir deploy-studio
> cd deploy-studio
> iwr -Uri https://github.com/vertigis/studio-base-internal/archive/refs/tags/v14982313549-master.zip -OutFile deploy.zip
> Expand-Archive -Path deploy.zip -DestinationPath .
> del deploy.zip

# Using git
> git clone --depth 1 --branch v14982313549-master https://github.com/vertigis/studio-base-internal deploy-studio
> cd deploy-studio
```
