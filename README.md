...
- [This
  Release](https://github.com/vertigis/studio-base-internal/releases/v15498172849-master)
  ( v15498172849-master )
...
> cd ~/deploy-studio
> curl -fsSL https://github.com/vertigis/studio-base-internal/archive/refs/tags/v15498172849-master.tar.gz | tar -xz
# If desired, use git:
> git clone --depth 1 --branch v15498172849-master https://github.com/vertigis/studio-base-internal ~/deploy-studio
> cd ~/deploy-studio
