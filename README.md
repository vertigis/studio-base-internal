...
- [This
  Release](https://github.com/vertigis/studio-base-internal/releases/v14136377569-master)
  ( v14136377569-master )
...
> mkdir deploy-studio
> cd deploy-studio
> curl -fsSL https://github.com/vertigis/studio-base-internal/archive/refs/tags/v14136377569-master.tar.gz -o deploy.tar.gz
> tar -xzf deploy.tgz
> del deploy.tgz
```
...
> mkdir deploy-studio
> cd deploy-studio
> iwr -Uri https://github.com/vertigis/studio-base-internal/archive/refs/tags/v14136377569-master.zip -OutFile deploy.zip
> exa -Path deploy.zip -DestinationPath .
> del deploy.zip
```

``` git
> git clone --depth 1 --branch v14136377569-master https://github.com/vertigis/studio-base-internal deploy-studio
> cd deploy-studio
```
